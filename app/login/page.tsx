...
export default function LoginPage({ onLogin, onSignUp, onForgotPassword }: LoginPageProps) {
  ...
  // Add this state for floating cards
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          ...
          >
            ...
            <h1 className="text-4xl font-bold text-white mb-2 font-['Poppins']">Memory Master</h1>
            <p className="text-white/70 font-['Nunito']">Welcome back! Ready to challenge your mind?</p>
          </motion.div>
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <motion.div
                ...
                className="space-y-2"
              >
                <label className="text-white/80 text-sm font-medium font-['Nunito']">Email or Username</label>
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-12 bg-white/10 border-white/20 text-white placeholder:text-white/50 rounded-xl h-12 font-['Nunito'] focus:border-yellow-400/50 focus:ring-yellow-400/20 transition-all duration-300"
                    required
                  />
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-12 pr-12 bg-white/10 border-white/20 text-white placeholder:text-white/50 rounded-xl h-12 font-['Nunito'] focus:border-yellow-400/50 focus:ring-yellow-400/20 transition-all duration-300"
                    required
                  />
                  <button
                    type="button"
              ...
              >
                <button
                  ...
                  className="text-yellow-400 hover:text-yellow-300 text-sm font-medium font-['Nunito'] transition-colors"
                >
                  Forgot Password?
                </button>
              </motion.div>
              ...
              >
                <Button
                  type="submit"
                  disabled={isLoading}
                  className="w-full bg-gradient-to-r from-yellow-400 to-orange-500 hover:from-yellow-500 hover:to-orange-600 text-black font-bold py-3 h-12 rounded-xl shadow-lg font-['Poppins'] transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98]"
                >
                  {isLoading ? (
                    <motion.div
                      animate={{ rotate: 360 }}
              ...
              >
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-4 bg-transparent text-white/60 font-['Nunito']">Or continue with</span>
                </div>
              </motion.div>
